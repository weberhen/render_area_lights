...
obj_positions = [[0,0,i/50+2] for i in range(-50,150+1,50)]
for i, obj_pos in enumerate(obj_positions):
    # obj_pos = np.array([-.5,0,.5])
    obj_pos = np.array(obj_pos)
    pickle_filename = '/Users/henriqueweber/codes/scripts_render/class_scene/class.pkl'
    filename = '/Users/henriqueweber/codes/scripts_render/class_scene/pred/class._texture.png'
    layout = '/Users/henriqueweber/codes/scripts_render/class_scene/class_layout.txt'
    background_filename = '/Users/henriqueweber/codes/scripts_render/class_scene/crop/class.jpg'
    ...
    compose(background_filename, 'final_render.exr', "final_render_"+str(i).zfill(3)+"_"+str(obj_pos[0])+"_"+str(obj_pos[1])+"_"+str(obj_pos[2])+".png", global_modifier_factor=.1)